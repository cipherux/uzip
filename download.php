...
<body>
	<div id="container">
			...
			<div style="background:#4617B4;padding-top:1px;padding-bottom:10px;margin-top:45px;padding-left:20px;color:#FFF;text-align:center;line-height:25px;" id="main-content">
				<h1>Download a copy of UZIP for yourself</h1>
					To download UZIP script, visit sourceforge.net<br/>
					Click on below link: <a style="color:#5DB2FF;" target="_blank" href="https://github.com/cipherux/uzip">https://github.com/cipherux/uzip</a>
			</div>	
